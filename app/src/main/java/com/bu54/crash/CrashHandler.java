...
//        sendCrashReportsToServer(mContext);
     ...
     * @param pw
     */
    private void collectUserInfo(PrintWriter pw) {
//        UserAccount userAccount = AppContext.getInstance().userAccount;
//        StringBuilder sb = new StringBuilder();
//        sb.append("UserInfo").append("\n");
//        sb.append("environment : ").append(AppConfig.getEnvirnmentName()).append("\n");
//        sb.append("mobile      : ").append(userAccount.mobile).append("\n");
//        sb.append("realname    : ").append(userAccount.real_name).append("\n");
//        sb.append("disname     : ").append(userAccount.display_name).append("\n");
//        sb.append("number      : ").append(userAccount.number).append("\n");
//        pw.println(sb.toString());
    }
}